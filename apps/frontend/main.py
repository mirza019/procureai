    ...
    with ui.column().classes("page-wrap page-enter w-full"):
        ...
        with ui.element("footer").classes("app-footer w-full"):
            with ui.row().classes("app-footer-inner items-center justify-center"):
                ...
                with ui.link(
                    target=settings.github_repository_url,
                    new_tab=True,
                ).classes("footer-source").props(
                    'aria-label="ProcureAI source code on GitHub" rel="noopener noreferrer" '
                    'title="View ProcureAI on GitHub"'
                ):
                    ui.html(
                        '<svg class="github-mark" viewBox="0 0 24 24" aria-hidden="true">'
                        '<path fill="currentColor" d="M12 .7a11.5 11.5 0 0 0-3.64 22.41c.58.11.79-.25.79-.56v-2.23c-3.22.7-3.9-1.37-3.9-1.37-.52-1.34-1.28-1.69-1.28-1.69-1.05-.72.08-.7.08-.7 1.16.08 1.77 1.19 1.77 1.19 1.03 1.77 2.7 1.26 3.36.96.1-.75.4-1.26.73-1.55-2.57-.29-5.27-1.28-5.27-5.68 0-1.26.45-2.28 1.19-3.09-.12-.29-.52-1.47.11-3.05 0 0 .97-.31 3.16 1.18a10.9 10.9 0 0 1 5.76 0c2.2-1.49 3.16-1.18 3.16-1.18.63 1.58.23 2.76.11 3.05.74.81 1.19 1.83 1.19 3.09 0 4.42-2.71 5.38-5.29 5.67.42.36.79 1.06.79 2.14v3.18c0 .31.21.68.8.56A11.5 11.5 0 0 0 12 .7Z"/>'
                        '</svg>'
                    )
                    ui.label("Source Code")
                    ui.tooltip("View ProcureAI on GitHub")
